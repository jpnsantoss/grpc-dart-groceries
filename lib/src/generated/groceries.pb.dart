...
class Categories extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Categories', createEmptyInstance: create)
...
class AllItemsOfCategory extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'AllItemsOfCategory', createEmptyInstance: create)
    ..a<$core.int>(1, _omitFieldNames ? '' : 'categoryId', $pb.PbFieldType.O3, protoName: 'categoryId')
    ..pc<Item>(2, _omitFieldNames ? '' : 'items', $pb.PbFieldType.PM, subBuilder: Item.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  AllItemsOfCategory copyWith(void Function(AllItemsOfCategory) updates) => super.copyWith((message) => updates(message as AllItemsOfCategory)) as AllItemsOfCategory;
